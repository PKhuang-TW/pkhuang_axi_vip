...
class axi_mem_model extends uvm_object;
    ...
    virtual function void process_w_op (
        ...
        bit [(`D_DATA_WIDTH_BIT>>3)-1:0]    strb,
        bit                             last
    );
        bit [2:0]                       size;
        ...
        for ( bit [`D_ADDR_WIDTH_BIT-1:0] i=0; i<(1 << size); i++ ) begin
    ...
    virtual function void process_r_op (
        ...
        output bit [`D_DATA_WIDTH_BIT-1:0]  data
    );
        bit [2:0]                   size;
        bit[`D_ADDR_WIDTH_BIT-1:0]      addr;
    ...
    virtual function void clr_id_info (
        ...
        bit [`D_ADDR_WIDTH_BIT-1:0]     start_addr;
